...
export class CompetitionActionMoveWetlandOpponentToken extends PlayerTurnRule<PlayerColor, MaterialType, LocationType, RuleId, PlayerColor> {
  ...
  public getPlayerMoves(): MaterialMove<PlayerColor, MaterialType, LocationType, RuleId, PlayerColor>[] {
    return this.colonizationHelper.computeCompetitionOpponentTokenOnBiotopeMoves(BiotopeType.Wetland)
  }
}
