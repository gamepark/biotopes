...
export class ExpansionActionPlaceTerritoryTokenOnWetlandRule extends PlayerTurnRule<PlayerColor, MaterialType, LocationType, RuleId, PlayerColor> {
  private readonly colonizationHelper = new ColonizationHelper(this.game)

  public getPlayerMoves(): BiotopesMove[] {
    return this.colonizationHelper.getPlaceTerritoryTokenMoves(BiotopeType.Wetland)
  }

  public afterItemMove(move: ItemMove<PlayerColor, MaterialType, LocationType>, context?: PlayMoveContext): BiotopesMove[] {
    return this.colonizationHelper.afterPlaceTerritoryTokenMove(move, EcosystemActionType.Expansion, BiotopeType.Wetland, context)
  }
}
