...
export class DrawMountainCubeRule extends PlayerTurnRule<PlayerColor, MaterialType, LocationType, RuleId, PlayerColor> {
  ...
  public getPlayerMoves(): MaterialMove<PlayerColor, MaterialType, LocationType, RuleId, PlayerColor>[] {
    return this.drawCubesHelper.getPlayerMoves(this.player, BiotopeType.Mountain)
  }
