...
describe('Rock species tests', () => {
  test('After an expansion on a mountain if the player has a Rock species, game should proceed to the DrawCubes rule for the current player and allow to draw 1 cube', () => {
    // Given
  ...
  test('After an expansion on a mountain if the player has a Rock species and player drew a cube, game should proceed to the ChooseAction rule for the next player', () => {
    ...
    playAction(
      rules,
      rules.material(MaterialType.Cube).location(LocationType.CubeStockpileSpot).id(BiotopeType.Mountain).moveItem({
  ...
  test('After a migration to a mountain if the player has a Rock species, game should proceed to the DrawCubes rule for the current player and allow to draw 1 cube', () => {
    // Given
