...
describe('Cosmopolitan and Mountain species combo tests', () => {
  test('Given an expansion on a mountain for a player having a partial migrator and a mountain species, game should proceed to the DrawCard rule for the current player and allow to draw 1 card', () => {
