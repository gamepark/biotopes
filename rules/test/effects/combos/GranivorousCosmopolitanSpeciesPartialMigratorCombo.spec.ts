...
describe('Cosmopolitan, Granivorous species and Partial migrator combo tests', () => {
  test('Given an expansion on a meadow for a player having a partial migrator, a granivorous species and a cosmopolitan species, game should proceed to the DrawCard rule for the current player and allow to draw 2 cards', () => {
