...
describe('Cosmopolitan, Aquatic and Partial migrator combo tests', () => {
  ...
  test('Given a migration to a mountain for a player having a partial migrator and an aquatic species, game should proceed to the DrawCard rule for the current player and allow to draw 2 cards', () => {
